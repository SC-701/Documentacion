# 📚 Documentación SC701 — Programación Web Avanzada

Guías completas para dominar la arquitectura de **3 proyectos integrados**: API REST, Web Razor Pages y React SPA.
...
- **[Glosario](referencias/glosario-tecnico.md)** — 60+ términos ES/EN
- **[FAQ](referencias/preguntas-frecuentes.md)** — 20+ respuestas
- **[Checklist](referencias/checklist-semanal.md)** — 14 semanas de hitos
...
| Sem | Tema | Carpeta | Estado |
|:---:|------|---------|:------:|
| 1-2 | Estructura API | Backend API | 🟢 |
| 3-4 | Servicios | Backend API | 🟡 |
| 5 | Frontends | Web + React | 🟡 |
| 6 | Seguridad | Seguridad | 🟠 |
| 7-9 | BD + Validación | Base de Datos | 🟠 |
| 10-14 | Deploy + Integración | Despliegue | 🔴 |

---

## 🔗 Enlaces

- **GitHub:** https://github.com/SC-701/2026C01
- **Código:** Semana 02 hasta Semana 14 en carpetas
- **Recursos:** Microsoft Learn, React Docs, Dapper Docs
...
- 60+ términos técnicos explicados
- 50+ ejemplos de código
- Estructura pedagógica (14 semanas)
